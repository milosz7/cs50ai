...
def load_data(filename):
    ...
    label_colname = "Revenue"
    labels = dataset.pop(label_colname)
    labels = labels.astype(int)

    dataset["Weekend"] = dataset["Weekend"].astype(int)
    dataset["VisitorType"] = dataset["VisitorType"].map(VISITOR_MAP)
    dataset["Month"] = dataset["Month"].map(MONTHS_MAP)
